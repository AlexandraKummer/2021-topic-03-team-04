...
ggplot(Total_Prot_norm_Rotated_df, aes(x=1:25))+
  ...
  scale_x_continuous(breaks=1:25)
```
Es werden vier dataframes erstellt:
1. Ctrl_Clean_Median 
2. RNAse_Clean_Median
3. Ctrl_Clean_Mean
4. RNAse_Clean_Mean

Alle 4 mit den dimensionen (3680x25). 1 und 2 enthalten den median aller 3 Repititions und 3 und 4 den Mean.

Auf grundlage des Papers:
[https://wis.kuleuven.be/statdatascience/robust/papers/2002/rousseeuwverboven-robustestimationinverysmallsampl.pdf]

Wird angenommen, dass der Median eine gute Methode für n=3 stichproben ist, die robust gegenüber OUtlieren ist.
