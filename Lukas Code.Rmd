...
ggplot(data.frame(t(Ctrl_median_df)), aes(x=1:25))+
  ...
  ggtitle("Comparizon Mean(red) and Median(blue) for Ctrl sample Protein RS9")+
  xlab("Fractions")+
  ylab("Normalized Protein Amount")+
  scale_x_continuous(breaks=1:25)
...
ggplot(data.frame(t(Ctrl_median_df)), aes(x=1:25))+
  ...
  ggtitle("Comparizon Mean(red) and Median(blue) for Ctrl sample Protein SCLY")+
  xlab("Fractions")+
  ylab("Normalized Protein Amount")+
  scale_x_continuous(breaks=1:25)
...
ggplot(data.frame(t(Ctrl_median_df)), aes(x=1:25))+
  ...
  ggtitle("Comparizon Mean(red) and Median(blue) for Ctrl sample Protein TRI59")+
  xlab("Fractions")+
  ylab("Normalized Protein Amount")+
  scale_x_continuous(breaks=1:25)
