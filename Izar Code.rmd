...
mean of RNAse and Ctrl reps
```{r}
# want mean of the reps, so again n,n+1,n+2 apply mean function to a temproary dataframe by row 
#result should be a 3680*25 df 
mean_clean_RNAse_df <- for i in length(clean_RNAse_df){
  
}


mean_clean_Ctrl_df <- for i in length(clean_Ctrl_df){
