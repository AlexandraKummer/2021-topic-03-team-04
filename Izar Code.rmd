...
Maybe try using harmonic mean so we dont need to remove outliers --- was nice but sucks with low outliers
...
'need to figure out how to save the results back into a 3680x75 df
...
check normality with rstatix::shapiro_test()
...
library(stats)
  ...
  wilcox.test(RNAse_median_df,Ctrl_median_df,two.sided,)
