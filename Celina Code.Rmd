...
maxima_Ctrl <- max_detec_df(Ctrl_lof_df, 0.2)#code läuft nicht, ist also kot lul. irgendeine bedingung hat Länge > 1 und das füllen der MAtrix gibt Ersetzung hat die Länge 0
maxima_Ctrl
