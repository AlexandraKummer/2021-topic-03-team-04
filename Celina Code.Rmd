...
max_value_RNAse_median <- max_value_func(maxima_RNAse_median, RNAse_mean_df)     
max_value_RNAse_median

max_value_RNAse_lof <- max_value_func(maxima_RNAse_lof, RNAse_mean_df)     
max_value_RNAse_lof

max_value_Ctrl_mean <- max_value_func(maxima_Ctrl_mean, RNAse_mean_df)     
max_value_Ctrl_mean

max_value_Ctrl_median <- max_value_func(maxima_Ctrl_median, RNAse_mean_df)     
max_value_Ctrl_median

max_value_Ctrl_lof <- max_value_func(maxima_Ctrl_lof, RNAse_mean_df)     
max_value_Ctrl_lof
